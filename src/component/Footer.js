      ...
      <div className="Footer">
        <div className="row">
          <div className="container1">
            ...
            <div>
              {" "}
              <h1 className="LogoInovation">
                &#123;Club <span className="inov">Innovation</span>&#125;
              </h1>
            </div>
            ...
            <br />
            <a href="" className="link1">
              <div className="link2">check out our game challenge</div>
            </a>
          </div>
          <div className="container2">
            ...
            <div className="signupText">
              Sign up to our Newsletter, to recieve updates on the latest news
